...
func (c *PrivacySettingsCore) UsersGetIsPremiumRequiredToContact(in *mtproto.TLUsersGetIsPremiumRequiredToContact) (*mtproto.Vector_Bool, error) {
	// TODO: not impl
	c.Logger.Errorf("users.getIsPremiumRequiredToContact blocked, License key from https://papercraft-official.github.io required to unlock enterprise features.")
