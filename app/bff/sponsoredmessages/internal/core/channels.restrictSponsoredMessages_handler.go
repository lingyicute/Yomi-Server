...
func (c *SponsoredMessagesCore) ChannelsRestrictSponsoredMessages(in *mtproto.TLChannelsRestrictSponsoredMessages) (*mtproto.Updates, error) {
	// TODO: not impl
	c.Logger.Errorf("channels.restrictSponsoredMessages blocked, License key from https://papercraft-official.github.io required to unlock enterprise features.")
